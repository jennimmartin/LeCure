    ...
    <section id="about">
      <div className="align-element">
        ...
        <p className="text-justify py-3">
          ...
          Liv Langma Advanced Disc 2, for the non-cycle savvy amongst you, a
          metallic purple bike. It’s actually not the bike I ordered, due to
          Covid and the shipping crisis my bike didn’t turn up! Giant suggested
          that I come in to take a look at something similar in my size that had
          just arrived.
        </p>
        <p className="text-justify py-3">
        ...
        <p className="text-justify py-3">
          Over the Christmas period I was reminded that tomorrow isn’t given and
          if I was ever going to join Rachael on this crazy adventure there was
